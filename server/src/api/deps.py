...
from src.pipelines import PipelineRegistry, StageRegistry
...
_stage_registry: StageRegistry | None = None
...
def init_deps(
    ...
    global _session_store, _pipeline_registry, _stage_registry, _server_stats, _crosstalk_service
    _session_store = store
    _pipeline_registry = registry
    _stage_registry = stage_registry if stage_registry is not None else registry.stage_registry
    _server_stats = stats
...
def get_stage_registry() -> StageRegistry:
    assert _stage_registry is not None
